...
export default function DriveResyncWrapper({ errorMessage }: DriveResyncWrapperProps) {
    ...
    return (
        <div className="flex flex-col items-center justify-center py-20 px-6 bg-white/50 dark:bg-slate-800/50 backdrop-blur-md rounded-2xl border border-slate-200/50 dark:border-slate-700/50 shadow-sm max-w-lg mx-auto mt-10">
            ...
            <button
                ...
                disabled={isSyncing}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#3B82F6] to-[#2563EB] text-white rounded-xl font-semibold text-sm shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-200 disabled:opacity-50 disabled:cursor-wait"
            >
                {isSyncing ? (
                    <>
            ...
            <p className="text-[10px] text-slate-400 dark:text-slate-500 mt-4 text-center">
                ...
                <a href="/dashboard/configuracoes" className="text-[#3B82F6] hover:underline font-medium">
                    Configurações
                </a>
            </p>
        </div>
